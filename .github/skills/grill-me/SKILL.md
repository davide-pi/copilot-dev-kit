...
When all branches are resolved, no open questions remain and reanalyzing the decision tree yields no new questions, produce a **Decision Summary** that includes:
